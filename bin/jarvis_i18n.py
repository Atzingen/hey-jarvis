...
STRINGS: dict[str, dict[str, str]] = {
    "pt-BR": {
        ...
        "ph_dictating": ("DITANDO", "Ctrl+Shift+K para e cola · qualquer outra tecla cancela"),
        "ph_polishing": ("REVISANDO", "pontuando e limpando hesitações..."),
        "ph_pasted": ("COLADO", "texto colado na janela ativa e no topo do histórico (Ctrl+V)"),
        "ph_copied": ("COPIADO", "texto no topo do histórico do clipboard"),
        "ph_cancelled": ("CANCELADO", "ditado descartado"),
        "dict_empty": "(nada reconhecido)",
        # terminal rascunho
        ...
        "model_output_cut": "Trabalho interrompido pelo Jarvis: {reason}.",
        "ev_tool": "executando",
    ...
    "en": {
        ...
        "ph_dictating": ("DICTATING", "Ctrl+Shift+K stops and pastes · any other key cancels"),
        "ph_polishing": ("POLISHING", "fixing punctuation, removing hesitations..."),
        "ph_pasted": ("PASTED", "text pasted into the active window and on top of the clipboard history"),
        "ph_copied": ("COPIED", "text on top of the clipboard history"),
        "ph_cancelled": ("CANCELLED", "dictation discarded"),
        "dict_empty": "(nothing recognized)",
        ...
        "model_output_cut": "Work stopped by Jarvis: {reason}.",
        "ev_tool": "running",
...
SETTING_TEXT_EN: dict[str, tuple[str, str]] = {
    ...
    "dictation_polish_model": ("Polish model", "Ollama model used to polish dictation."),
