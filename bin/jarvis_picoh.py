...
LOOKS: dict[str, Look] = {
    "listening":    dict(colour=(0, 200, 60), pulse=None, shape="large", bright=10,
                         nod=6, turn=5, eyes=(5, 5), wander=False),
    "followup":     dict(colour=(0, 120, 40), pulse=None, shape="large", bright=8,
                         nod=6, turn=5, eyes=(5, 5), wander=False),
    "recording":    dict(colour=(0, 255, 80), pulse="fast", shape="large", bright=10,
                         nod=6.5, turn=5, eyes=(5, 5), wander=False),
    "transcribing": dict(colour=(0, 150, 255), pulse=None, shape="eyeball", bright=8,
                         nod=5.5, turn=5, eyes=(5, 6), wander=False),
    "thinking":     dict(colour=(255, 130, 0), pulse="breathe", shape="smallball", bright=8,
                         nod=6.5, turn=5, eyes=(4, 8), wander=True),
    "consent":      dict(colour=(255, 20, 0), pulse="blink", shape="square", bright=10,
                         nod=5, turn=5, eyes=(5, 5), wander=False),
    "speaking":     dict(colour=(80, 140, 255), pulse=None, shape="eyeball", bright=10,
                         nod=5.5, turn=5, eyes=(5, 5), wander=False),
    "handoff":      dict(colour=(160, 0, 255), pulse="breathe", shape="sunglasses", bright=8,
                         nod=5, turn=5, eyes=(5, 5), wander=False),
    "dictating":    dict(colour=(0, 200, 255), pulse="fast", shape="eyeball", bright=10,
                         nod=4.5, turn=5, eyes=(5, 3), wander=False),
    "polishing":    dict(colour=(255, 130, 0), pulse="breathe", shape="smallball", bright=8,
